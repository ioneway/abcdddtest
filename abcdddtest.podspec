...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/iOSxiaoping/abcdddtest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'iOSxiaoping' => '373850874@qq.com' }
  s.source           = { :git => 'https://github.com/iOSxiaoping/abcdddtest.git', :tag => s.version.to_s }
